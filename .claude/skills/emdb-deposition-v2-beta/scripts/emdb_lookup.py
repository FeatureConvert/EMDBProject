...
Usage:
  .venv/bin/python3 .claude/skills/emdb-deposition-v2-beta/scripts/emdb_lookup.py lookup --accession EMD-8000
  .venv/bin/python3 .claude/skills/emdb-deposition-v2-beta/scripts/emdb_lookup.py exists --accession EMD-8000
